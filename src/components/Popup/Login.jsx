...
const Login = ({ setOrderPopup, setRegisterPopup }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const response = { success: true, isEmailVerified: true };
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 backdrop-blur-sm flex items-center justify-center">
      <div className="w-[90%] max-w-3xl bg-white dark:bg-gray-900 rounded-2xl shadow-lg relative flex flex-col sm:flex-row overflow-hidden">
        
        {/* Left Image */}
        <div className="hidden sm:block w-1/2 bg-white dark:bg-gray-800">
